...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cbrcours_currencylastupdate', 'last_update', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'CurrencyLastUpdate.last_update'
        db.alter_column(u'cbrcours_currencylastupdate', 'last_update', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
