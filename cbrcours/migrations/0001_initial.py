...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cbrcurrencies_currencylastupdate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('last_update', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'cbrcurrencies', ['CurrencyLastUpdate'])

        # Adding model 'Currency'
        db.create_table(u'cbrcurrencies_currency', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'cbrcurrencies', ['Currency'])


    def backwards(self, orm):
        # Deleting model 'CurrencyLastUpdate'
        db.delete_table(u'cbrcurrencies_currencylastupdate')

        # Deleting model 'Currency'
        db.delete_table(u'cbrcurrencies_currency')
